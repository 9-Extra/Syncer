...
std::string digestString(const std::string &input) { return digestString(input.data(), (unsigned int)input.size()); }
...
std::string digest(const std::string &input) { return digest(input.data(), (unsigned int)input.size()); }
